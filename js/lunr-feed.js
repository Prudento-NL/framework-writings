...
$(document).ready(function() {
  $('input#search').on('keyup', function () {
    ...
    for (var item in result) {
      ...
      var searchitem = '<div class="result"><div class="result-body"><h2><a href="{{ site.baseurl }}'+ store[ref].link+ '" class="search-title">'+ store[ref].title+ '</a></h2><div class="search-time">'+ store[ref].date + '</div><p>'+ store[ref].excerpt + '</p></div>';
